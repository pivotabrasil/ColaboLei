...
ActiveRecord::Schema.define(:version => 20130622153828) do
  ...
  add_index "proposal_comments", ["proposal_id"], :name => "index_comments_on_proposal_id"
  add_index "proposal_comments", ["user_id"], :name => "index_comments_on_user_id"
